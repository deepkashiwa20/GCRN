...
from GCRNconv import GCRN

def get_model():   
    model = GCRN(num_nodes=args.num_nodes, input_dim=args.input_dim, output_dim=args.output_dim, horizon=args.horizon, 
                 rnn_units=args.rnn_units, rnn_layers=args.rnn_layers, embed_dim=args.embed_dim, cheb_k=args.cheb_k).to(device)
...
parser.add_argument("--patience", type=int, default=50, help="patience used for early stop")
parser.add_argument("--batch_size", type=int, default=64, help="size of the batches")
parser.add_argument("--lr", type=float, default=0.01, help="base learning rate")
parser.add_argument("--steps", type=eval, default=[30, 100], help="steps")
...
logger.info('cheb_k', args.cheb_k)
